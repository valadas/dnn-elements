...
const uploadIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M5 20h14v-2H5v2zm0-10h4v6h6v-6h4l-7-7-7 7z"/></svg>`;

const photoCameraIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><circle cx="12" cy="12" r="3.2"/><path d="M9 2 7.17 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2h-3.17L15 2H9zm3 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z"/></svg>`;
    ...
    return (h(Host, { ref: e => this.dropzone = e, class: "dropzone", onDragOver: this.handleDragOver, onDrop: this.handleDrop, onDragLeave: () => this.dropzone.classList.remove("dropping") }, !this.takingPicture &&
      [
        ...
        h("p", null, "- ", (_b = this.resx) === null || _b === void 0 ? void 0 :
          _b.or, " -"),
        h("label", { class: "upload-file" }, h("input", { type: "file", ref: el => this.fileInput = el, onChange: e => this.handleUploadButton(e.target) }), h("span", { innerHTML: uploadIcon }), "\u00A0", (_c = this.resx) === null || _c === void 0 ? void 0 :
          _c.uploadFile),
        this.canTakeSnapshots &&
          [
            h("p", null, "- ", (_d = this.resx) === null || _d === void 0 ? void 0 :
              _d.or, " -"),
            h("button", { onClick: () => this.takeSnapshot() }, h("span", { innerHTML: photoCameraIcon }), "\u00A0", (_e = this.resx) === null || _e === void 0 ? void 0 :
              _e.takePicture)
          ]
      ], this.takingPicture &&
      h("div", { class: "video-preview" }, h("video", { ref: e => this.videoPreview = e }), h("button", { onClick: () => this.applySnapshot() }, h("span", { innerHTML: photoCameraIcon }), (_f = this.resx) === null || _f === void 0 ? void 0 :
        _f.capture))));
  }
};
